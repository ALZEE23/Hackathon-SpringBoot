...
## Project Information
- **Project path**: d:\Coding\Proyek\Niagapulse
- **Working branch**: appmod/java-upgrade-20251201173620

- **Java version**: 17

## Development Environment
- **Source JDK path (Java 17)**: C:\Users\MarMikir\.jdk\jdk-17.0.16\bin
- **Target JDK path (Java 21)**: <span style="color:red"><to be installed, or specify the path here></span>
- **Build tool type**: Maven Wrapper
- **Build tool path**: d:\Coding\Proyek\Niagapulse
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20251201173620`.
